...
public class ChronoUnitsPeriodDurationExample {
 ...
 public static void main(String[] args) {
  ...
  // ChronoUnit examplesThe values() method of ChronoUnit enum is used to an array
  //containing the units of this ChronoUnit, in the order, they are declared.
  ...
  // Period example
  LocalDate octDate = LocalDate.of(2021, 12, 1);
